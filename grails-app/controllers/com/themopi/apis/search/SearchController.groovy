...
class SearchController {
	...
	def appSearch(){
		try{
			String tokenValue = request.getHeader('X-Auth-Token')
			println "hashTagId ===== "+params.hashTagId
			def surveys = surveySearchService.appSearch(params.searchCategory,params.limit,params.offset,params.location,tokenValue,params.hashTagId)
			responseObject.error = false
